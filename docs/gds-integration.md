...
- tenant-owned reservation operation/attempt persistence with exact idempotency, credential-version binding, serializable claims, durable provider-request markers, and fail-closed ambiguity state;
