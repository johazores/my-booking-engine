...
Price-changing or broader rental extensions/amendments, delivery semantics, automatic tenant late-fee policy, partial/provider-backed rental settlement, customer self-service, fulfillment notifications, and external synchronization remain separate contracts.
