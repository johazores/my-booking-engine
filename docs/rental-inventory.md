...
If return has not been recorded when the exclusive committed end date is reached in the retained booking-location timezone, the physical unit becomes overdue open custody and is excluded from new availability, hold, conversion, reschedule-target, and replacement-unit authority until return is recorded or a supported extension advances the committed end. This does not itself create an automatic fee. After real return evidence exists, the separate late-return assessment may retain `FEE_ASSESSED` or `WAIVED` authority and an assessed fee may later retain exact manual/offline settlement evidence.

Price-changing or broader rental extensions/amendments, delivery semantics, automatic tenant late-fee policy, provider-backed or mixed-provider rental settlement, customer self-service, fulfillment notifications, and external synchronization remain separate contracts.
...
- price-changing or broader rental extensions/amendments, automatic tenant late-fee policy, delivery semantics, customer self-service, or fulfillment notifications
