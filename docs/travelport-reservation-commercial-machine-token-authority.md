...
- exact `Result` / `ErrorDetail` / `Warning` discriminators, rejection of legacy `Errors`, `Category`, and `traceID` aliases, bounded integral error/warning status authority, and rejection of explicit empty result collections;
