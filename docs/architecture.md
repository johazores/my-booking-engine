...
- rental inventory and staff operations: tenant-owned unit types, operating locations, physical units, unavailable-date blocks, daily rates/rate overrides, availability holds, bookings/allocations, price-neutral reschedule/custody extension, unit substitution, cancellation, manual booking-price settlement, custody/early release, overdue/missed-pickup authority, maintenance, inspection/damage, security bonds, and late-return evidence
...
Tour inventory currently stops at tenant-owned products, dated departures, configured sellable capacity, and optional add-on definitions. Appointment inventory stops at services, staff eligibility, and recurring weekly working-hour configuration. Rental inventory now extends into tenant-scoped availability/pricing holds, staff hold-to-booking conversion, same-unit price-neutral reschedule and custody extension, same-type/same-location unit substitution, pre-pickup cancellation, manual booking-price settlement, pickup/return/early-release custody, overdue and missed-pickup authority, maintenance, return inspection/damage, security bonds, and late-return commercial evidence. Those rental workflows remain staff-operated and provider-neutral. Online/card rental settlement, customer delivery semantics, price-changing or unit-type/location-changing rental amendments, notifications/external synchronization, and customer self-service remain separate contracts. Tour and appointment inventory records still require explicit workflow contracts before they become customer holds, bookings, payments, generated appointment slots, or supplier reservations.
