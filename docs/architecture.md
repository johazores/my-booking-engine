...
- rental inventory and staff operations: tenant-owned unit types, operating locations, physical units, unavailable-date blocks, daily rates/rate overrides, availability holds, bookings/allocations, price-neutral reschedule/custody extension, one supported same-unit price-changing commercial date amendment with exact retained manual/offline settlement and protected effective post-apply refunds, post-amendment neutral reschedule/substitution authority, unit substitution, cancellation against combined effective settlement, manual booking-price settlement, custody/early release, overdue/missed-pickup authority, maintenance, inspection/damage, security bonds, and late-return policy/assessment/settlement evidence
...
- price-changing hospitality date rescheduling only if product requirements justify extending the hospitality amendment stay/inventory contract
...
- customer-facing tour-operator, appointment, and rental availability/pricing/booking/provider workflows built on their implemented domain foundations
- broader rental commercial/fulfillment contracts such as unit-type/location-changing or currency-changing amendments, a second/chained price-changing amendment, provider-backed settlement, cancellation fees, delivery/one-way semantics, notifications, and external synchronization only from concrete product requirements
...
Tour inventory currently stops at tenant-owned products, dated departures, configured sellable capacity, and optional add-on definitions. Appointment inventory stops at services, staff eligibility, and recurring weekly working-hour configuration. Rental inventory now extends into tenant-scoped availability/pricing holds, staff hold-to-booking conversion, same-unit price-neutral reschedule and custody extension, one supported same-unit price-changing commercial date amendment with exact adjustment settlement/final apply/protected effective post-apply refunds, later post-amendment neutral reschedule authority, same-type/same-location unit substitution including the supported effective-commercial baseline, pre-pickup cancellation after exact-zero combined effective settlement, manual booking-price settlement, central cross-ledger manual-reference ownership, pickup/return/early-release custody, overdue and missed-pickup authority, maintenance, return inspection/damage, security bonds, and late-return policy/assessment/settlement evidence. Those rental workflows remain staff-operated and provider-neutral. Online/card rental settlement, customer delivery semantics, unit-type/location-changing or currency-changing commercial changes, a second/chained price-changing amendment, cancellation fees, notifications/external synchronization, and customer self-service remain separate contracts. Tour and appointment inventory records still require explicit workflow contracts before they become customer holds, bookings, payments, generated appointment slots, or supplier reservations.
...
Rental availability uses its own physical-unit authority. Effective allocation derives from retained reschedule/substitution evidence, and post-amendment neutral date/substitution decisions additionally require the accepted effective commercial baseline to reconcile. Cancellation releases the retained allocation only after current combined effective settlement reaches exact zero and all lifecycle/custody guards still pass.
...
Rental pricing remains a separate daily-rate evidence contract. The immutable `RentalBooking.totalMinor` is booking-time evidence; after the one supported applied price-changing commercial date amendment, current accepted money comes from retained amendment/effective-settlement evidence rather than rewriting that original field. Broader/chained repricing remains deliberately unsupported until concrete requirements exist.
...
Rental booking management uses a distinct one-amendment contract rather than inheriting hospitality mutation semantics. A same-unit price-changing date review can prepare one rental commercial amendment, record exact manual/offline adjustment or compensation evidence, apply the retained reschedule under booking/unit locks, and expose protected effective settlement/refund authority afterward. The original rental booking money snapshot remains immutable, and later neutral reschedules/substitutions must prove they preserve the accepted effective post-amendment amount. Chained repricing, unit-type/location-changing changes, provider-backed rental amendment settlement, and cancellation-fee policy remain separate contracts.
