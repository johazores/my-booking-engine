...
test('permission lists are stable and least-privilege by default', () => {
  ...
  assert.deepEqual(permissionsForOrganizationRole('STAFF'), ['membership:read', 'customer:read', 'customer:manage', 'inventory:read', 'availability:read', 'pricing:read', 'booking:read']);
