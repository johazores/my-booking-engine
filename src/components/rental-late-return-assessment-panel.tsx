import { RentalLateReturnSettlementPanel } from '@/components/rental-late-return-settlement-panel.tsx';
  ...
  if (data.assessment) {
    ...
    return <>
      <section className="sf-inventory-card" aria-labelledby="rental-late-return-assessment-title">
        ...
        <p className="sf-field-hint">This assessment remains immutable commercial authority. It does not change the committed rental period or custody; any supported payment/refund evidence is retained separately below.</p>
      </section>
      {data.assessment.outcome === 'FEE_ASSESSED' && data.assessment.feeMinor !== null ? <RentalLateReturnSettlementPanel
        organizationId={organizationId}
        actorUserId={actorUserId}
        bookingId={bookingId}
        assessmentId={data.assessment.id}
        currency={data.assessment.currency}
        feeMinor={data.assessment.feeMinor}
        canManage={canManage}
      /> : null}
    </>;
  }
