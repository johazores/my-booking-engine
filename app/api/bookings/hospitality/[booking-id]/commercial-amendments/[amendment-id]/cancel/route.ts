import { cancelHospitalityBookingCommercialAmendmentTransport } from '@/server/bookings/hospitality-booking-commercial-amendment-transport-service.ts';
import {
...
export async function POST(
  ...
  const observation = createRequestObservation(request, { operation: 'booking.hospitality-commercial-amendment.cancel' });
  ...
  try {
    ...
    const amendment = await cancelHospitalityBookingCommercialAmendmentTransport({
      organizationId: context.organizationId,
