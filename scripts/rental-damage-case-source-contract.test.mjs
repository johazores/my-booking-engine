...
const panel = fs.readFileSync('components/rental-damage-case-panel.tsx', 'utf8');
const inspectionPanel = fs.readFileSync('components/rental-return-inspection-panel.tsx', 'utf8');
