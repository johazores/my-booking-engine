...
- customer-facing rental booking/payment/self-service, unit-type/location-changing or price-changing/broader rental amendments/extensions, online/card/provider-backed or mixed-provider rental settlement, cancellation fees/automatic refunds, customer-facing pickup/drop-off/delivery and one-way/opening-hour semantics, automatic damage liability, richer maintenance vendor/parts/labor/actual-cost workflows, notifications, and external synchronization on top of the implemented staff hold-to-booking/read/reschedule-custody-extension/same-type-same-location-unit-substitution/cancellation/multi-source-manual-settlement/pickup-return/early-return-release/operational-availability/maintenance/return-inspection/damage-liability/security-bond/late-return-policy/late-return infrastructure; and
