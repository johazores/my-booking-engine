...
- tenant-owned rental inventory with unit types, operating locations, physical units, unavailable date blocks, daily rate configuration and date-range rate overrides, temporary holds, conversion-authority review, durable confirmed rental bookings/physical-unit allocations, tenant-scoped staff booking list/detail, same-unit price-neutral date rescheduling plus narrow same-unit later-end custody extension with append-only evidence, one supported same-unit price-changing commercial date amendment with reviewed before/after terms, exact manual/offline adjustment or compensation evidence, final locked apply, protected effective post-apply settlement/refunds, later price-neutral reschedules/extensions at the accepted effective amount, same-type/same-location physical-unit substitution with append-only evidence including the supported post-amendment commercial baseline, terminal inventory-release cancellation against combined effective settlement, staff-only multi-source partial/full manual/offline booking-price settlement with source-attributed partial/full refunds, central tenant-scoped manual-reference isolation across all current rental money ledgers, append-only pickup/return custody evidence, missed-pickup and overdue-custody inventory protection/queues, explicit whole-day early-return inventory release, separate operational availability, durable maintenance work orders, append-only return-condition inspection with non-clear unit quarantine, explicit non-clear damage-case assessment/waiver/resolution evidence, one append-only post-closure customer-damage-liability decision, separate exact manual/offline customer-damage settlement or exact security-bond forfeiture, security-bond requirement/collection/release evidence, versioned unit-type late-return fee policy revisions with non-retroactive automatic fee math, explicit late-return assessment plus exact manual/offline fee settlement, audited lifecycle controls, and booked-inventory protection;
...
- customer-facing rental booking/payment/self-service, unit-type/location-changing or currency-changing commercial changes, a second/chained price-changing rental amendment and broader repricing beyond the one supported same-unit commercial date-amendment contract, online/card/provider-backed or mixed-provider rental settlement, cancellation fees/automatic refunds, customer-facing pickup/drop-off/delivery and one-way/opening-hour semantics, automatic damage liability, richer maintenance vendor/parts/labor/actual-cost workflows, notifications, and external synchronization on top of the implemented staff hold-to-booking/read/reschedule-custody-extension/commercial-amendment/effective-settlement/same-type-same-location-unit-substitution/cancellation/multi-source-manual-settlement/pickup-return/early-return-release/operational-availability/maintenance/return-inspection/damage-liability/security-bond/late-return-policy/late-return infrastructure; and
...
- `docs/rental-booking-commercial-amendments.md`
- `docs/rental-booking-commercial-amendment-settlement.md`
- `docs/rental-booking-effective-settlement.md`
...
- `docs/rental-damage-settlement.md`
- `docs/rental-security-bond.md`
- `docs/rental-late-return-policy.md`
- `docs/rental-late-return-assessment.md`
- `docs/rental-late-return-settlement.md`
